...
#### Upstate Assembly Districts (Outside NYC)
```{r, cache=TRUE}
...
#### Downstate Assembly Districts (Within NYC)
```{r, cache=TRUE}
...
#### Downstate Assembly Districts (Inside NYC)
```{r, cache=TRUE}
...
#### Upstate Senate Districts (Outside NYC)
```{r, cache=TRUE}
...
#### Downstate Senate Districts (Inside NYC)
```{r, cache=TRUE}
...
```{sql, connection = con, output.var="executed_evictions_25", cache=TRUE}
SELECT
